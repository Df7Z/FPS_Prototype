...
namespace ECS_MONO
{
    public class EcsSystemAbstract<E, C1, C2, C3, C4, C5> : EcsSystemBase<EcsBaseSystemComponents<E, C1, C2, C3, C4, C5>, E>
        ...
        where C5 : class, IEcsComponent
    {
        ...
        internal override void InitNewComponentField(in E entity, in EcsBaseSystemComponents<E, C1, C2, C3, C4, C5> components)
        {
        ...
        internal override void UpdateSystem(EcsBaseSystemComponents<E, C1, C2, C3, C4, C5> components) => 
        ...
        internal override void LateUpdateSystem(EcsBaseSystemComponents<E, C1, C2, C3, C4, C5> components) => 
        ...
        internal override void FixedUpdateSystem(EcsBaseSystemComponents<E, C1, C2, C3, C4, C5> components) => 
